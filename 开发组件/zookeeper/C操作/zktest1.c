...
int main(int argc, const char *argv[])
{
    ...
    int timeout = 30000;
    char context[100] = "hello zookeeper.";
    zoo_set_debug_level(ZOO_LOG_LEVEL_WARN);

    zhandle_t* zkhandle = zookeeper_init(host,
            zktest_watcher_g, timeout, 0, context, 0);
    if (zkhandle == NULL) {
...
// source /etc/profile
// g++ kk.cpp -I/usr/local/include/zookeeper/ -lzookeeper_mt

// g++ kk.cpp -I/usr/local/include/zookeeper/ -L/usr/local/lib/ -lzookeeper_mt 
