...
class RankDB:
	...
	def initSql(self):
		try:
			self.sql_connect=MySQLdb.connect(host=MYSQL_HOST,port=MYSQL_PORT,user=MYSQL_USER,passwd=MYSQL_PASSWORD,charset="utf8")
			self.sql_connect.autocommit(1);
			self.sql_connect.set_character_set('utf8')
